...
\begin{document}
    ...
    A constant concentration of \ce{CO2} should remain constant, regardless of $K(z)$, as long as it is positive. This test is shown in \autoref{constant_cons}, both for constant and varying diffusivity $K(z)$.
