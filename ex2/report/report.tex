...
\begin{document}
    ...
    To analyze the error, the simulation is run with differnt step lengths $h$, for the same simulation time $t_0 = 0.1$. The result is shown in \ref{error}. 
    ...
    \begin{figure}
        \centering
        \includegraphics[width=0.8\textwidth]{../plots/decay.pdf}
    \end{figure}
