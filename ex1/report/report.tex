...
\begin{document}
    ...
    %TODO: Rerun and check these results
    ...
    There are placed out 4000 particles, of radius $R=0.0045$ and mass in the range $[0.02, 0.15]$.
    This means the packing fraction is $4000 \cdot \pi R^2 / 0.5 \approx 0.509$.
